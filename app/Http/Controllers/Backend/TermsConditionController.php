...
class TermsConditionController extends Controller
{
    ...
    {
        $terms = TermsConditions::orderBy('id', 'asc')->wherenull('deleted_by')->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $banner->move(public_path('uploads/terms'), $bannerName);
            }
            
            // ✅ Save Record to Database
            $sports = new TermsConditions();
            ...
            return redirect()->route('manage-terms-conditions.index')
    ...
    public function edit($id)
    {
        ...
        return view('backend.terms.edit', compact('terms'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                if ($term->banner_image && file_exists(public_path('uploads/terms/' . $term->banner_image))) {
                    @unlink(public_path('uploads/terms/' . $term->banner_image));
                }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = TermsConditions::findOrFail($id);
            $industries->update($data);

            return redirect()->route('manage-terms-conditions.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
