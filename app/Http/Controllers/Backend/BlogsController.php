...
class BlogsController extends Controller
{
    ...
    {
        $blog = Blog::findOrFail($id);
        return view('backend.blog.list.edit', compact('blog'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('manage-blogs.index')->with('message', 'Blog updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect()->route('manage-blogs.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
