        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Navigation Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Navigation Details</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input"
                                          novalidate
                                          action="{{ route('manage-navigations.store') }}"
                                          method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="image">
                                                Upload Image <span class="txt-danger">*</span>
                                            </label>
                                            <input class="form-control"
                                                   id="image"
                                                   type="file"
                                        ...
                                        <div class="col-12 text-end mt-3">
                                            <a href="{{ route('manage-navigations.index') }}" class="btn btn-danger px-4">Cancel</a>
