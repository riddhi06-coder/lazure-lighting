                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->banner_images)
                                                <!-- Show Image -->
                                                <img src="{{ asset('uploads/home/banner/' . $item->banner_images) }}" 
                                                     alt="Banner Image" 
                                                     style="max-height: 60px;">
                                            
                                            @elseif($item->banner_video)
                                                <!-- Show Video Preview -->
                                                <video width="250px" controls style="max-height: 250px; border: 1px solid #ddd; padding: 5px;">
                                                    <source src="{{ asset('uploads/home/banner/' . $item->banner_video) }}">
                                        ...
                                        <td>
            <form action="{{ route('manage-banner.priority.update', $item->id) }}" 
                  method="POST" 
                  style="width: 80px;">
                @csrf
                @method('PATCH')
