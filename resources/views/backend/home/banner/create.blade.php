                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-banner.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                       ...
                                       <!-- Banner Image-->
                                        ...
                                        <!-- Banner Video -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="banner_video">Banner Video (optional)</label>
                                            <input class="form-control" id="banner_video" type="file" name="banner_video" accept=".mp4, .mov, .avi, .webm" onchange="previewBannerVideo()">
                                            <div class="invalid-feedback">Please upload a valid video.</div>
                                    
                                            <small class="text-secondary"><b>Note: Recommended size less than 5MB.</b></small><br>
                                            <small class="text-secondary"><b>Note: Allowed formats: .mp4, .mov, .avi, .webm</b></small>
                                    
                                            <!-- Video Preview -->
                                            <div id="bannerVideoPreviewContainer" style="display: none; margin-top: 10px;">
                                                <video id="banner_video_preview" controls style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
