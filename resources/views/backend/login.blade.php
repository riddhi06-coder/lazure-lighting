        ...
        <body>
            ...
            <div class="row m-0">
                ...
                <div class="login-card login-dark">
                    <div>
                    <div style="background-color: black; padding: 1px;"><a class="logo" href="#"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo.png') }}" alt="looginpage" style="max-width: 60% !important; margin-top:20px;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/logo.png') }}" alt="looginpage" style="max-width: 60% !important; margin-top:20px;"></a></div>
                    <br>
