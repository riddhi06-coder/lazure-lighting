        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Light Applications Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Light Applications</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-light-application.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
        
                                        <!-- Application Type-->
                                        <div class="col-md-6">
                                            <label class="form-label" for="light_application_type">Light Application Type <span class="txt-danger">*</span></label>
                                            <input class="form-control" id="light_application_type" type="text" name="light_application_type" placeholder="Enter Application Type" required>
