        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Individual Series Catalog Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Individual Series Catalog</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-individual-series-catalog.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="section_title" id="section_title" class="form-control" placeholder="Enter Heading title">
                                        </div>
                                        ...
                                        <div class="col-xxl-6 col-sm-12">
                                            <label class="form-label" for="document_file">Upload Document <span class="txt-danger">*</span></label>
                                            ...
                                            <small class="text-secondary"><b>Note: Allowed formats: PDF, DOC, DOCX (max 3MB).</b></small>
                                        
                                            <!-- 📄 Preview Container -->
                                            <div id="documentPreviewContainer" style="display:none; margin-top:10px;">
                                                
                                                <!-- For PDF Preview -->
                                                <iframe id="document_pdf_preview" src="" style="width:100%; height:300px; display:none; border:1px solid #ddd;"></iframe>
                                        
                                                <!-- For DOC/DOCX Filename -->
