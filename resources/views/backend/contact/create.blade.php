                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-contact.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="iframe_url" type="text" name="iframe_url" placeholder="Enter Iframe Gmap URL" required>
                                        ...
                                        <div class="col-md-12 mt-4">
                                            ...
                                            <table class="table table-bordered" id="locationTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody id="location-table-body">
                                                    <tr>
                                                        <td><input type="text" name="locations[0][name]" class="form-control" placeholder="Enter Name" required></td>
                                                        <td><input type="text" name="locations[0][address]" class="form-control" placeholder="Enter Address" required></td>
                                                        <td><input type="url" name="locations[0][gmap_url]" class="form-control" placeholder="Enter Gmap URL" required></td>
                                            ...
                                            <table class="table table-bordered" id="dynamicTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody id="social-media-table-body">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="url" name="social_media[0][link]" class="form-control"
                                                                placeholder="Enter Social Media URL" required>
                                                        </td>
                                                        <td>
