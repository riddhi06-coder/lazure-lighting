                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form action="{{ route('manage-contact.update', $contact->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <!--Gmap URL-->
                                    <div class="col-md-12">
                                        <label class="form-label" for="iframe_url">Iframe Gmap URL <span class="txt-danger">*</span></label>
                                        <input class="form-control" id="iframe_url" type="text" name="iframe_url" placeholder="Enter Iframe Gmap URL"  value="{{ old('iframe_url', $contact->iframe_url) }}" required>
                                        <div class="invalid-feedback">Please enter a Iframe Gmap URL.</div>
                                    </div> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="border rounded p-3 text-center h-100">
                                                    ...
                                                    <input type="file"
                                                           name="image_one"
                                                           class="form-control image-input mb-3"
                                                           accept="image/*"
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <img id="preview1"
                                                             class="img-fluid {{ $contact->image_one ? '' : 'd-none' }}"
                                                             src="{{ $contact->image_one ? asset('uploads/contact/'.$contact->image_one) : '' }}"
                                                             style="max-height: 180px; border: 1px solid #ddd; padding: 5px; background: #fff;">
                                                    </div>
                                            
                                                    <div class="mt-3 text-start">
                                                        <small class="text-secondary d-block">
                                                            <b>Note:</b> Max size 2MB
                                                        </small>
                                                        <small class="text-secondary d-block">
                                                            <b>Note:</b> jpg, jpeg, png, webp only
                                                        </small>
                                                    </div>
                                           ...
                                           <div class="col-md-4">
                                                <div class="border rounded p-3 text-center h-100">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <img id="preview2"
                                                             class="img-fluid {{ $contact->image_two ? '' : 'd-none' }}"
                                                             src="{{ $contact->image_two ? asset('uploads/contact/'.$contact->image_two) : '' }}"
                                                             style="max-height: 180px; border: 1px solid #ddd; padding: 5px; background: #fff;">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="border rounded p-3 text-center h-100">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <img id="preview3"
                                                             class="img-fluid {{ $contact->image_three ? '' : 'd-none' }}"
                                                             src="{{ $contact->image_three ? asset('uploads/contact/'.$contact->image_three) : '' }}"
                                                             style="max-height: 180px; border: 1px solid #ddd; padding: 5px; background: #fff;">
