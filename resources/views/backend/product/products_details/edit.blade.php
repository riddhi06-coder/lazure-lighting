	   ...
	   <!--end sidebar wrapper-->
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                 ...
                                 <form class="row g-3 needs-validation custom-input"
                                        novalidate
                                        action="{{ route('manage-detailed-page.update', $banner_details->id) }}"
                                        method="POST"
                                       ...
                                       <!-- Banner Image-->
                                        <div class="col-md-6">
                                            ...
                                            <!-- Show Existing Image -->
                                            @if(!empty($banner_details->banner_image))
                                                <div style="margin-top: 10px;">
                                                    <img src="{{ asset($banner_details->banner_image) }}" alt="Banner" class="img-fluid"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="sub_product_id" name="sub_product_id" required>
                                                ...
                                                @foreach($sub_product as $sp)
                                                    <option value="{{ $sp->id }}"
                                                        {{ $banner_details->sub_product_id == $sp->id ? 'selected' : '' }}>
                                                        {{ $sp->sub_product }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="editor" name="sub_product_description" rows="6" placeholder="Enter details about the sub product..." required>{{ old('sub_product_description', $banner_details->sub_product_description) }}</textarea>
                                        </div>
                                        ...
                                        <div class="table-container mt-5" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="galleryTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $galleryImages = json_decode($banner_details->gallery_images, true) ?? [];
                                                    @endphp
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="file"
                                                                    ...
                                                                    onchange="previewGalleryImage(this, {{ $index }})">
                                                    ...
                                                    @empty
                                                        <!-- Default Row if no gallery images exist -->
                                                        <tr>
                                                            <td>
                                                                <input type="file"
                                                                    name="gallery_image[]"
                                                                    class="form-control"
                                                                    accept=".png, .jpg, .jpeg, .webp"
                                                                    onchange="previewGalleryImage(this, 0)" required>
                                                                <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                                                <br>
                                                                <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
                                                            </td>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="sec_title" type="text" name="sec_title" placeholder="Enter Section Title "  value="{{ old('sec_title', $banner_details->sec_title) }}"  required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($banner_details->thumbnail_image))
                                                <div style="margin-top: 10px;">
                                                    <img src="{{ asset($banner_details->thumbnail_image) }}" alt="Thumbnail" class="img-fluid"
                                                        style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                </div>
                                            @endif
                                        ...
                                        <div class="table-container mt-5" style="margin-bottom: 20px;">
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                <h5 class="mb-0"><strong>Specifications</strong></h5>
                                            ...
                                            <table class="table table-bordered p-3" id="tabletTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $specs = json_decode($banner_details->specifications, true) ?? [];
                                                    @endphp
                                                    @forelse($specs as $index => $spec)
                                                        <tr>
                                                            <td><input type="text" name="specifications[]" value="{{ $spec['specification'] ?? '' }}" class="form-control" required></td>
                                                            <td><input type="text" name="value[]" value="{{ $spec['value'] ?? '' }}" class="form-control" required></td>
                                                            <td><button type="button" class="btn btn-danger removeTabletRow">Remove</button></td>
                                                        </tr>
                                                    @empty
                                                        <tr>
                                                            <td><input type="text" name="specifications[]" class="form-control" placeholder="Enter Specifications" required></td>
                                                            <td><input type="text" name="value[]" class="form-control" placeholder="Enter Value" required></td>
                                                            <td><button type="button" class="btn btn-primary" id="addTabletRow">Add More</button></td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="table-container mt-5" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="tabletTable1" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $features = json_decode($banner_details->features, true) ?? [];
                                                    @endphp
                                                    @forelse($features as $feature)
                                                        <tr>
                                                            <td><input type="text" name="table_heading[]" value="{{ $feature['heading'] ?? '' }}" class="form-control" required></td>
                                                            <td><input type="text" name="desc[]" value="{{ $feature['description'] ?? '' }}" class="form-control" required></td>
                                                            <td><button type="button" class="btn btn-danger removeTabletRow1">Remove</button></td>
                                                        </tr>
                                                    @empty
                                                        <tr>
                                                            <td><input type="text" name="table_heading[]" class="form-control" placeholder="Enter Heading" required></td>
                                                            <td><input type="text" name="desc[]" class="form-control" placeholder="Enter Description" required></td>
                                                            <td><button type="button" class="btn btn-primary" id="addTabletRow1">Add More</button></td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
        ...
        <script>
            $(document).ready(function () {
                // Start rowId from the last existing index in Blade
                let rowId = {{ count($galleryImages) }};  
