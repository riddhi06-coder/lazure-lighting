                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-category.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                       ...
                                       <!-- Banner Image-->
                                        ...
                                        <!-- Application Type-->
                                        <div class="col-md-6">
                                            <label class="form-label" for="category">Sub Category <span class="txt-danger">*</span></label>
