                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('manage-category.create') }}" class="btn btn-primary px-5 radius-30">+ Add Sub Category</a>
                    </div>

                    <div class="table-responsive custom-scrollbar">
                        <div class="d-flex justify-content-end mb-2">
                            <div style="width: 300px;">
                                <input type="text" id="categorySearch" placeholder="Search Main Category or Sub Category" class="form-control">
                            </div>
                        </div>
                       <table class="display" id="basic-1">
                            ...
                            <tbody>
                                @foreach($applications as $appType => $groupedCategories)
                                    <tr>
                                        <td colspan="5" style="font-weight: bold; background: #f0f0f0;">Main Category: {{ $appType }}</td>
                                    </tr>
