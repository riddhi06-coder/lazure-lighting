        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Main Category Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Main Category Details</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-application.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                       ...
                                       <!-- Banner Image-->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="application_type" type="text" name="application_type" placeholder="Enter Main Category" required>
