        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Application Type Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Application Type Details</li>
                </ol>
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-application.store') }}" method="POST" enctype="multipart/form-data">
                                       ...
                                       <!-- Banner Image-->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="application_type" type="text" name="application_type" placeholder="Enter Application Type" required>
