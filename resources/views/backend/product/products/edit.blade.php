...
<script>
    $(document).ready(function () {
        let selectedCategoryId = $('#parent_category').val();

        // Function to fetch categories
        function fetchCategories(appId, selectedCategoryId = null) {
            if (appId) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (key, category) {
                            options += `<option value="${category.id}" ${category.id == selectedCategoryId ? 'selected' : ''}>${category.category}</option>`;
                        });
        ...
        // ✅ Initial load
        fetchCategories($('#application_type').val(), selectedCategoryId);
