    ...
    @include('components.backend.head')
                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-product.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <select class="form-control select2" id="application_type" name="application_type[]" multiple required>
                                                @foreach($applications as $application)
                                                    <option value="{{ $application->id }}"
                                                        @if(is_array(old('application_type')) && in_array($application->id, old('application_type'))) selected @endif>
                                       ...
                                       <!-- Category -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="other_thumbnail_image" type="file" name="other_thumbnail_image" accept=".jpg, .jpeg, .png, .webp" onchange="previewotherThumbnailImage()" required>
                                            <div class="invalid-feedback">Please upload a Thumbnail Image.</div>
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small><br>
                                            <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
       ...
       @include('components.backend.main-js')
        ...
        <script>
            ...
            function previewotherThumbnailImage() {
        ...
        <script>
            $('#application_type').on('change', function () {
                let appIds = $(this).val(); // array of selected IDs
                console.log("Selected Application IDs:", appIds);
