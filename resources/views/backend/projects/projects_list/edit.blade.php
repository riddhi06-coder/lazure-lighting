                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-projects.update', $projects_list->id) }}" 
                                        ...
                                        <!-- Projects Category -->
                                        <div class="col-sm-6">
                                            <label class="form-label" for="project_category">Projects Category <span class="txt-danger">*</span></label>
                                            ...
                                            <div class="invalid-feedback">Please select a Projects Category.</div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control" id="project_name" type="text" name="project_name" 
                                                value="{{ $projects_list->project_name }}" placeholder="Enter Project Name" required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <small class="text-secondary"><b>Note: Only .jpg, .jpeg, .png, .webp files allowed.</b></small>

                                            <!-- Image Preview -->
                                            @if($projects_list->thumbnail_image)
                                            <div id="bannerImagePreviewContainer" style="margin-top: 10px;">
                                                <img id="banner_image_preview" src="{{ asset($projects_list->thumbnail_image) }}" 
                                        ...
                                        <!-- Project Location -->
                                        <div class="col-sm-6">
                                            <label class="form-label" for="project_location">Project Location <span class="txt-danger">*</span></label>
                                            <input class="form-control" id="project_location" type="text" name="project_location" 
                                                value="{{ $projects_list->project_location }}" placeholder="Enter Project Location" required>
                                        ...
                                        <div class="col-xxl-6 col-sm-12">
                                            ...
                                            <input type="text" name="meta_title" id="meta_title" class="form-control" 
                                                value="{{ old('meta_title', $projects_list->meta_title) }}">
                                        </div>

                                        <div class="col-xxl-6 col-sm-12">
                                            <label for="meta_description">Meta Description </label>
                                            <textarea name="meta_description" id="meta_description" class="form-control" rows="4">{{ old('meta_description', $projects_list->meta_description) }}</textarea>
                                        </div>
                                         ...
                                         <div class="col-xxl-6 col-sm-12">
                                            ...
                                            <textarea name="cannonical" id="cannonical" class="form-control" rows="4">{{ old('cannonical', $projects_list->cannonical) }}</textarea>
                                        </div>
                                        
                                        
                                        <div class="col-xxl-6 col-sm-12">
                                            <label for="hreflang">HrefLang</label>
                                            <textarea name="hreflang" id="hreflang" class="form-control" rows="4">{{ old('hreflang', $projects_list->hreflang) }}</textarea>
                                        </div>
                                        
                                        
                                        <div class="col-xxl-6 col-sm-12">
                                            <label for="og_tag">OG Tag</label>
                                            <textarea name="og_tag" id="og_tag" class="form-control" rows="4">{{ old('og_tag', $projects_list->og_tag) }}</textarea>
                                        </div>
                                        
                                        
                                        <div class="col-xxl-6 col-sm-12">
                                            <label for="og_tag">Twitter Card Tag</label>
                                            <textarea name="twitter_card_tag" id="twitter_card_tag" class="form-control" rows="4">{{ old('twitter_card_tag', $projects_list->twitter_card_tag) }}</textarea>
                                        </div>
