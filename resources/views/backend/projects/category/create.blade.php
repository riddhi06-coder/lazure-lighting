        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Projects Category Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Projects Category</li>
                </ol>
                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-project-category.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            ...
                                            <input class="form-control" id="project_category" type="text" name="project_category" placeholder="Enter Projects Category" required>
