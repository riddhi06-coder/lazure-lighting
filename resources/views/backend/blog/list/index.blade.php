                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
								...
								<a href="{{ route('manage-blogs.create') }}" class="btn btn-primary px-5 radius-30">+ Add Blogs</a>
							</div>
                            ...
                            <tbody>
                                @foreach($blogs as $key => $blog)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manage-blogs.edit', $blog->id) }}" class="btn btn-sm btn-primary">Edit</a><br><br>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                document.querySelectorAll(".status-toggle").forEach(toggle => {
                    toggle.addEventListener("change", function () {
                        ...
                        fetch(`/lazure-lighting/manage-blogs/status/${blogId}`, {
                            method: "POST",
                            headers: {
