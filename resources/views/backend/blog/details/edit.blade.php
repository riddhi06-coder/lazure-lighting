                            ...
                            <div class="tab-content" id="wizard-tabContent">
                               <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                          action="{{ route('manage-blog-details.update', $blog->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="existing_blog" id="existing_blog" class="form-select" required>
                                                ...
                                                @foreach($blogs as $b)
                                                    <option value="{{ $b->id }}" {{ $b->id == $blog->blog_id ? 'selected' : '' }}>
                                                        {{ $b->blog_title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($blog->banner_image)
                                                <div id="bannerImagePreviewContainer" style="margin-top: 10px;">
                                                    <img id="banner_image_preview" src="{{ asset($blog->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                </div>
                                            @else
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="blog_heading" id="blog_heading" class="form-control" placeholder="Enter heading" value="{{ $blog->blog_heading}}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="blog_content" id="editor" class="form-control" rows="10" placeholder="Enter blog content..." required>
                                                {!! $blog->blog_content !!}
                                            </textarea>
