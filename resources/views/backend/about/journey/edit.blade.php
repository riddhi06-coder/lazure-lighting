        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Journey Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Journey Details</li>
                </ol>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-our-journey.update', $journey->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="bannerImagePreviewContainer" style="margin-top: 10px;">
                                                <img id="banner_image_preview" 
                                                    src="{{ $journey->banner_image ? asset('uploads/about/'.$journey->banner_image) : '' }}" 
                                                    alt="Preview" class="img-fluid" 
                                                    style="max-height: 200px; border: 1px solid #ddd; padding: 5px;"
                                                    @if(!$journey->banner_image) style="display:none;" @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="year" type="text" name="year" 
                                                placeholder="Enter Year" required value="{{ old('year', $journey->year) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="achievement" type="text" name="achievement" 
                                                placeholder="Enter Achievement" required value="{{ old('achievement', $journey->achievement) }}">
                                            <div class="invalid-feedback">Please enter an Achievement.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="headingIconPreviewContainer" style="margin-top: 10px;">
                                                <img id="heading_icon_preview" 
                                                    src="{{ $journey->heading_icon ? asset('uploads/about/'.$journey->heading_icon) : '' }}" 
                                                    alt="Preview" class="img-fluid" 
                                                    style="max-height: 100px; border: 1px solid #ddd; padding: 5px;"
                                                    @if(!$journey->heading_icon) style="display:none;" @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="editor" name="description" rows="4" 
                                                        placeholder="Enter Description" required>{{ old('description', $journey->description) }}</textarea>
