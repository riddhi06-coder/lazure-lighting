...
<head>
    ...
    <section class="product-listing interior-spaces-page-wrap">
        ...
        <div class="container">
            @foreach($products as $productName => $subProducts)
                @if($subProducts->count() > 0)  {{-- show only if sub_products exist --}}
                        ...
                        @foreach($subProducts as $subProduct)
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="product-item">
                                    ...
                                    <div class="icon">
                                        <a href="{{ route('subproduct.detail', [$subProduct->application_slug, $subProduct->sub_product_slug ?? $subProduct->product_slug]) }}" 
                                        class="arrow">
