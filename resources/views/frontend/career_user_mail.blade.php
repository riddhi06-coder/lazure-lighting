...
<div class="email-container">
    ...
    <div class="content">
        ...
        <p>
            ...
            We have received your application for: <strong>{{ $positionApplied }}</strong>
        </p>

        <p style="margin-top: 20px;">
            Our Team will review your details and get in touch with you shortly if shortlisted.
        </p>
        
        <p style="margin-top: 20px;">
            Resume is attached in the mail.
        </p>
